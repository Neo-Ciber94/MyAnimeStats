...
<!-- License: CC Attribution. Made by BomSymbols: https://creativemarket.com/BomSymbols -->
<svg
	width={size}
	height={size}
	viewBox="0 0 91 91"
...
>
	...
	<g>
		<g>
			...
			<path
				class="st0"
				d="M10.7,38.2C16,41,20,46.7,20.2,52.8c0.2,6.4-3.6,13.2-8.9,16.6c-4.2,2.7,0.5,9,4.2,5.5    c6.4-6.1,11.5-13.7,10.7-23c-0.8-8-5.9-15.5-14.1-17C10.2,34.5,8.7,37.2,10.7,38.2L10.7,38.2z"
			/>

			<path
				class="st0"
				d="M81.7,36.3c-8.2,1.5-13.3,9.1-14.1,17c-0.9,9.2,4.3,16.9,10.7,23c3.6,3.4,8.5-2.7,4.2-5.5    c-5.4-3.4-9.1-10.3-8.9-16.6c0.2-6.1,4.2-11.8,9.5-14.6C85,38.6,83.6,35.9,81.7,36.3L81.7,36.3z"
			/>
		</g>
	</g>
</svg>
